    ...
    public class FirebaseAuthService : IFirebaseAuth
    {
        ...
        public async Task<FirebaseAuthResponseModel> LoginWithEmailPassword(string email, string password)
        {
            try
            {
                ...
                return new FirebaseAuthResponseModel() { Status = false, Response = "Correo electronico sin verificar. Revisa tu correo" };
            }
            catch (Exception ex)
            {
                return new FirebaseAuthResponseModel() { Status = false, Response = ex.Message };
        ...
        public async Task<FirebaseAuthResponseModel> ResetPassword(string email)
        {
            try
            {
                ...
                return new FirebaseAuthResponseModel() { Status = true, Response = "Correo de recuperacion ha sido enviado a tu direccion de correo electronico" }; ;
            }
            catch (Exception ex)
            {
                return new FirebaseAuthResponseModel() { Status = false, Response = ex.Message };
        ...
        public async Task<FirebaseAuthResponseModel> SignUpWithEmailPassword(string username, string email, string password)
        {
            try
            {
                ...
                return new FirebaseAuthResponseModel() { Status = true, Response = "Revisa tu correo registrado, se ha enviado un correo de verificacion." }; ;
            }
            catch (Exception ex)
            {
                return new FirebaseAuthResponseModel() { Status = false, Response = ex.Message };
